...
CMD java  -cp '/home/sunbird/lms/lms-service-1.0-SNAPSHOT/lib/*' -Dplay.server.http.idleTimeout=30s play.core.server.ProdServerStart  /home/sunbird/lms/lms-service-1.0-SNAPSHOT
