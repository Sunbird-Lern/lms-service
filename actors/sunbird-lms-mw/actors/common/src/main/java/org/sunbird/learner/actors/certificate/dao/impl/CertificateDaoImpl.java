...
public class CertificateDaoImpl implements CertificateDao {
  ...
  private Util.DbInfo certificateTemplate_db =
      Util.dbInfoMap.get(CourseJsonKey.CERTIFICATE_TEMPLATE_DB);

  @Override
  public void add(Map<String, Object> certificateMap) {
    certificateMap.put(CourseJsonKey.LAST_UPDATED_ON, new Timestamp(Instant.now().toEpochMilli()));
    cassandraOperation.insertRecord(
        certificateTemplate_db.getKeySpace(),
        certificateTemplate_db.getTableName(),
        certificateMap);
  }

  @Override
  public List<Map<String, Object>> readById(String courseId, String name) {
    Map<String, Object> primaryKey = new HashMap<>();
    primaryKey.put(JsonKey.COURSE_ID, courseId);
    if (name != null) {
      primaryKey.put(JsonKey.NAME, name);
    }
  ...
  @Override
  public void delete(String courseId, String name) {
