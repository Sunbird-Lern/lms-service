...
public class BulkUploadProcessDaoImpl implements BulkUploadProcessDao {
  ...
  public Response create(BulkUploadProcess bulkUploadProcess, RequestContext requestContext) {
    ...
    Response response = cassandraOperation.insertRecord(KEYSPACE_NAME, TABLE_NAME, map, requestContext);
  ...
  @Override
  public Response update(BulkUploadProcess bulkUploadProcess, RequestContext requestContext) {
    Map<String, Object> map = mapper.convertValue(bulkUploadProcess, Map.class);
    ...
    return cassandraOperation.updateRecord(KEYSPACE_NAME, TABLE_NAME, map, requestContext);
  }

  @Override
  public BulkUploadProcess read(String id, RequestContext requestContext) {
    Response response = cassandraOperation.getRecordByIdentifier(KEYSPACE_NAME, TABLE_NAME, id, null, requestContext);
