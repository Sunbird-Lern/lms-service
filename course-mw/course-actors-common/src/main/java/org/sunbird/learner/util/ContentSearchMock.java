...
public class ContentSearchMock {
    ...
    private static final Dispatcher DISPATCHER = new Dispatcher() {
        ...
        public MockResponse dispatch(RecordedRequest request) {
            String path = Pattern.compile("^(\\w+)\\s+(\\S+)\\s+HTTP/\\d\\.\\d")
                    .matcher(request.getRequestLine())
                    .results()
                    .findFirst()
    ...
    public static void setup() throws IOException {
        ...
        RESPONSES.put("http://localhost:9080/content/v3/read",
                new MockResponse()
        ...
        RESPONSES.put("http://localhost:9080/content/v3/search",
                new MockResponse()
                        .setHeader("Content-Type", "application/json")
                        .setResponseCode(200)
        ...
        RESPONSES.put("http://localhost:9080/content/v2/update",
                new MockResponse()
                        .setHeader("Content-Type", "application/json")
                        .setResponseCode(200)
        ...
        Unirest.setProxy(new HttpHost("localhost", 9080, "http"));
    }
