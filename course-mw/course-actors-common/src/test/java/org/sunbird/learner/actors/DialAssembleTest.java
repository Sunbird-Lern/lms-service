...
public class DialAssembleTest {
    ...
    @Test
    public void testUserProfileDataSingleBoardWithContents() throws Exception {
        List<Map<String, Object>> sectionList = mapper.readValue(contentSectionsStr, new TypeReference<List<Map<String, Object>>>(){});
        Map<String, Object> userProfile = new HashMap<String, Object>(){{
            put("board", "KA");
        }};
    ...
    @Test
    public void testUserProfileDataMultiBoardWithContents() throws Exception {
        List<Map<String, Object>> sectionList = mapper.readValue(contentSectionsStr, new TypeReference<List<Map<String, Object>>>(){});
        Map<String, Object> userProfile = new HashMap<String, Object>(){{
            put("board", Arrays.asList("KA", "MH"));
        }};
    ...
    @Test
    public void testUserProfileDataInvalidBoardWithContents() throws Exception {
        List<Map<String, Object>> sectionList = mapper.readValue(contentSectionsStr, new TypeReference<List<Map<String, Object>>>(){});
        Map<String, Object> userProfile = new HashMap<String, Object>(){{
            put("board", "JK");
        }};
