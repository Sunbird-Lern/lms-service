...
public class CourseEnrollmentActor extends BaseActor {
  ...
  private static String EKSTEP_COURSE_SEARCH_QUERY =
      "{\"request\": {\"filters\":{\"courseType\": [\"CurriculumCourse\", \"TrainingCourse\"], \"contentType\": [\"Course\"], \"objectType\": [\"Content\"], \"identifier\": \"COURSE_ID_PLACEHOLDER\", \"status\": [\"Live\", \"Unlisted\"]},\"limit\": 1}}";
